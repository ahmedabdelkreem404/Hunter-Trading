  ...
  return (
    ...
    >
      <motion.button
        ...
        className="group relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[#0088cc] to-[#0066aa] text-white shadow-lg sm:h-16 sm:w-16"
      >
        {/* Pulse rings */}
      ...
      {whatsappUrl && (
        <motion.button
          ...
          className="group relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white shadow-lg sm:h-16 sm:w-16"
        >
